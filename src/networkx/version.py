...
version_info = ('networkx', 1, 5, '7534d8095e2c')

# Format: a 'datetime.datetime' instance
date_info = datetime.datetime(2011, 6, 4, 9, 49, 49, 116031)

# Format: (vcs, vcs_tuple)
vcs_info = ('mercurial', ('7534d8095e2c', 'networkx-1.5'))
